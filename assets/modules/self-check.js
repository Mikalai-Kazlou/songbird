const txtSelfCheck =
  ...
  + "\n"
  + "\nАудиоплеер + 30"
  + "\n - Kастомный, функционал полностью такой же, как в демо приложения, могут быть небольшие отличия в оформлении + регулятор громкости звука + 30"
  + "\n"
